# FreewheelBridge (freewheelbridge)
...
Place keys in `freewheelbridge/signing/`:
```
freewheelbridge/signing/platform.pk8
freewheelbridge/signing/device_platform.x509.pem
```
